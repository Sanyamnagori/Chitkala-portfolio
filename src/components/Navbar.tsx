...
export function Navbar() {
  return (
    <header className="sticky top-0 z-50 w-full bg-chitkala-red">
      <div
      ...
      >
        ...
        <nav
          className="hidden items-center font-[family-name:var(--font-cabinet)] font-medium text-white lg:flex"
